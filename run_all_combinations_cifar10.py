"""Run CIFAR-10 encoder/decoder SAPU combinations.

Defaults match the existing 20-epoch MNIST-style sweep:

    5 warmup epochs + 15 cosine epochs + 0 prune epochs
"""
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    ...
    parser.add_argument("--output-root", default="sweep_runs_20ep_cifar10")
    ...
    parser.add_argument(
        ...
        help="Extra arguments passed to train_cifar10.py after `--`.",
    )
