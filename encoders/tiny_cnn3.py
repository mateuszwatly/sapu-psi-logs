"""Three-layer tiny CNN encoder for MNIST."""
...
class TinyCNN3Encoder(nn.Module):
    """Three convolution layers, returning a 7x7 token grid."""
    ...
    def __init__(
        ...
        self.net = nn.Sequential(
            ...
            nn.GELU(),
            nn.Conv2d(hidden_channels, embed_dim, kernel_size=3, stride=1, padding=1),
            nn.GELU(),
